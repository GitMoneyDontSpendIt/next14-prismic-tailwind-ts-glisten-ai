...
const icons = {
  gear: <PiGear className="text-3xl text-blue-400" />,
  cycle: <PiArrowsClockwise className="text-3xl text-blue-400" />
}
  ...
  return (
    ...
    >
      ...
      <div className="mt-16 grid items-center gap-8 rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:gap-0 lg:py-12">
        <div className="">
          <div className="w-fit rounded-lg bg-blue-500/15 p-4 text-3xl">
